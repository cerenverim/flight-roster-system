...
class Roster(models.Model):
    ...
    flight_crew_trainee = models.ManyToManyField(FlightCrew, related_name="flight_crew_trainee")  # [0..2]
    flight_cabin_crew_senior = models.ManyToManyField(CabinCrew,
                                                      related_name="flight_cabin_crew_senior")  # [1..4]
    flight_cabin_crew_junior = models.ManyToManyField(CabinCrew,
                                                      related_name="flight_cabin_crew_junior")  # [4..16]
    flight_cabin_crew_chef = models.ManyToManyField(CabinCrew,
                                                    related_name="flight_cabin_crew_chef")  # [0..2]
    flight_passengers = models.ManyToManyField(PlacedPassenger, related_name="flight_passengers")  # [0..*]

    flight_menu = models.ManyToManyField(Dish) # This is the final menu (standard + the crews)


class Flight(models.Model):
    flight_number = models.CharField(max_length=6, primary_key=True)
    flight_roster = models.OneToOneField(Roster, on_delete=models.CASCADE)
    ...
    connecting_flight = models.OneToOneField(SharedFlightInfo, blank=True, null=True, on_delete=models.CASCADE)
